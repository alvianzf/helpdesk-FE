<template>
    <div>
        <textarea ref="textSuggestionRef" v-model="inputVal" @blur="textSuggestionControl" v-on:keyup="getReferralSuggestion(inputVal)" :name="name" style="width: 100%;height: 100%;margin-bottom: 0px;" class="form-control"></textarea>
