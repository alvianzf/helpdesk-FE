      ...
      >
        <ul class="list-unstyled">
          <li :class="{ active : selectedParentMenu==='dashboard'}">
             <router-link :class="{ active : selectedParentMenu==='dashboard' }" @click.native="changeSelectedParentHasNoSubmenu('dashboard')" to="/app/dashboard/start" tag="li">
                <a><i class="iconsminds-shop"></i> Dashboard </a>
              </router-link>
          </li>
          <li :class="{ active : selectedParentMenu==='peaf' }">
            <a @click.prevent="openSubMenu($event,'peaf')" href="#peaf">
    ...
    <div class="sub-menu">
      ...
      >
        <ul
          class="list-unstyled"
          data-link="peaf"
          :class="{'d-block':selectedParentMenu==='peaf' }"
        >
          <router-link tag="li" to="/app/peaf/start">
            <a>
