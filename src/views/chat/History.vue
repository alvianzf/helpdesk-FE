<template>
    <div>
        ...
        <b-row>
            <b-col sm="12" md="12">
                <b-card>
                    <b-table responsive="sm" selectable :items="items" :fields="fields" :current-page="currentPage" :per-page="perPage" :fixed="true" @row-selected="onRowSelected">
...
export default {
    ...
    methods: {
        ...
        onRowSelected(items) {
            if(items.length > 0) {
                this.$refs.modalDetail.getChat(items[0].id)
